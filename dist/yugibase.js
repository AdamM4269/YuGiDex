...
export async function DisplayDatabase(filter) {
...
function TranslateTypeReverse(typeName) {
    switch (typeName) {
...
function TranslateRaceReverse(raceName) {
    switch (raceName) {
        case "": return 0;
...
function TranslateAttributeReverse(attributeName) {
